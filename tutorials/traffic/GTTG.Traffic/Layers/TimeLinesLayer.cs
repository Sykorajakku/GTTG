...
namespace GTTG.Traffic.Layers {
    ...
    public class TimeLinesLayer : ContentDrawingLayer {
        ...
        protected override void OnDraw(DrawingCanvas drawingCanvas) {
            ...
            foreach (var minute in timeContext.GetDateTimesByPeriod(timeContext.Start, new TimeSpan(0, 10, 00))) {
            ...
            foreach (var halfHour in timeContext.GetDateTimesByPeriod(timeContext.Start, new TimeSpan(0, 30, 00))) {
